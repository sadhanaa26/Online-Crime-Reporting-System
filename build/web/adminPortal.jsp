...
<html>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item active">
                        <a class="nav-link" href="adminPortal.jsp">Admin Portal <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-fluid">
        ...
        <form class="form-container" action="./adminVer" method="post">
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Username</label>
            <input type="text" size="50" class="form-control" id="exampleFormControlInput1" name="usern" required>
        </div>
        <div class="mb-3">
            <label for="inputPassword2" class="visually-hidden">Password</label>
            <input type="password" size="50" class="form-control" id="inputPassword2" name="pass" required>
        </div>
