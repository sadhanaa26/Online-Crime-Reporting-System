    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row justify">
                <form class="form-container" action="ViewComplaint.jsp">
                    <div class="mb-3">
                        <label for="comp">View:</label>
                        <select class="form-select form-select-lg mb-3" id="comp" name="show">
                            <option>All</option>
        ...
        <p class="h1" style="text-indent:25px; margin-top:25px; margin-bottom:50px;"><%=show%> Complaints</p>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">accused name</th>
                    <th scope="col">accused phone No.</th>
            ...
            Connection connect = DriverManager.getConnection(url,user,password);
                        ...
                        if (show.equals("All")) {
                            ...
                            query = "select * from accused_details where status='" + show + "'";
                        }
                ...
                <tr>
                    ...
                    <td><a href="expandComp.jsp?id=<%=rs.getInt("accused_id")%>">view</a>
                    </td>
                </tr>
                <%
                    }%>
