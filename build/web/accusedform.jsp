<%-- 
    Document   : accusedform.jsp
    Created on : Apr 28, 2021, 3:20:25 PM
    Author     : HP
--%>
...
<body>
    ...
    <div class="form-container">
        ...
        <form action = "./InsertData2" method="post">
          <div class="mb-3">
            <label for="formGroupExampleInput" >Name of the Accused Person</label>
            <input type="text" class="form-control" placeholder="Enter Accused Name" name="accused_name">
          </div>
          <div class="mb-3">
            <label for="formGroupExampleInput5" >Accused Phone Number</label>
            <input type="number" class="form-control" placeholder="Enter Accused Phone Number" name ="accused_phoneno">
          </div>
          <div class="mb-3">
            <label for="formGroupExampleInput2" >Type of Crime</label>
            <input type="text" class="form-control" placeholder="Enter the type of Crime" name="type_of_crime">
          </div>
          <div class="mb-3">
            <label for="formGroupExampleInput2" >Location of Crime</label>
            <input type="text" class="form-control" placeholder="Enter the Location of Crime" name="loc_of_crime">
          </div>
          <div class="mb-3">
            <label for="formGroupExampleInput3" >Date of Crime</label>
            <input type="date" class="form-control" placeholder="Enter the Date of Crime" name="date_of_crime">
          </div>
          <div class="mb-3">
            <label for="exampleFormControlTextarea6">Crime Incident Description</label>
            <textarea class="form-control" rows="10" name="crime_incident_desc">Enter here</textarea>
          </div>
          <br>
          <button class="btn btn-primary">Submit All Details</button>
          </form>
    <br>
</div>
<br>
