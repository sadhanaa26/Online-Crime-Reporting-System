<%-- 
    Document   : liveNews.jsp
    Created on : Apr 26, 2021, 5:17:42 PM
    Author     : HP
--%>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="#">Crime News<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <%
        ...
        try{
            ...
            String q = "select * from news_info order by news_id desc";
    ...
    <div class="container my-4">
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7">
                <h2 class="featurette-heading"><%= resultset.getString("title") %></h2>
                <p class="lead"><%= resultset.getString("desc_event") %></p>
            </div>
            <div class="col-md-5">
                <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src="<%= resultset.getString("image") %>" alt="">
            </div>
        </div>
        <br>
        <hr>
