    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <form class="form-container" action="adminPassC" method="post" oninput='pass2.setCustomValidity(pass2.value != pass1.value ? "Passwords do not match." : "")'>
                    <h2>Change Password</h2>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Current Password</label>
                        <input type="password" size="50" class="form-control" id="exampleFormControlInput1" name="passc" required>
                    </div>
                    <div class="mb-3">
                        <label for="inputPassword1" class="visually-hidden">New Password</label>
                        <input type="password" size="50" class="form-control" id="inputPassword1" name="pass1" pattern=".{6,}" title="Six or more characters" required>
                    </div>
                    <div class="mb-3">
                        <label for="inputPassword2" class="visually-hidden">Confirm New Password</label>
                        <input type="password" size="50" class="form-control" id="inputPassword2" name="pass2" required>
                    </div>
