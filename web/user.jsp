<%-- 
    Document   : user
    Created on : May 7, 2021, 7:18:11 PM
    Author     : HP
--%>
...
<div class="container">
    ...
    <div class="row">
      <div class="col-sm">
        <a href="reportCrime.jsp"><img style= "width: 80%; height: 80%" src="Crime Reporting/update.webp" alt=""></a>
        <br>
        <br>
        <h3>Edit Details</h3>
      </div>
      <div class="col-sm">
        <a href="accusedform.jsp"><img style= "width: 80%; height: 80%; background-color:#fff"  src="Crime Reporting/add.jpg" alt=""></a>
        <br>
        <br>
        <h3>Add Complaint</h3>
      </div>
      <div class="col-sm">
        <a href="trackCrime.jsp"><img style= "width: 80%; height: 80%" src="Crime Reporting/check status.png" alt=""></a>  
        <br>
        <br>
        <h3>Complaint Status</h3>
      </div>
      <div class="col-sm">
          <a href="updatePassword.jsp"><img style= "width: 80%; height: 80%" src="Crime Reporting/update_password.svg" alt=""></a>
        <br>
        <br>
