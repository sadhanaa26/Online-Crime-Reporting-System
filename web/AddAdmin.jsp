    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <form class="form-container" action="addAdmin" method="post" oninput='pass2.setCustomValidity(pass2.value != pass1.value ? "Passwords do not match." : "")'>
                    <h2>Add Admin</h2>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Username</label>
                        <input type="text" size="50" class="form-control" id="exampleFormControlInput1" name="uname" required>
                    </div>
                    <div class="mb-3">
