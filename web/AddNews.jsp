    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <form class="form-container" action="./newsProcess" method="post" oninput='pass2.setCustomValidity(pass2.value != pass1.value ? "Passwords do not match." : "")'>
                    <h2>Add News</h2>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Date and Time</label>
                        <input type="date" size="50" class="form-control" id="exampleFormControlInput1" name="date" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput2" class="form-label">Title</label>
                        <input type="text" size="50" class="form-control" id="exampleFormControlInput2" name="title" required>
                    </div>
                    <div class="mb-3">
                        <label for="input3" class="form-label">Description</label>
                        <textarea class="form-control" id="input3" name="crime_desc" rows="4" cols="50" required>
                        </textarea>
                    </div>
                    <div class="mb-3">
                        <label for="input4" class="form-label">Image</label>
                        <input type="file" accept="image/*" class="form-control" id="input4" name="img">
                    </div>
